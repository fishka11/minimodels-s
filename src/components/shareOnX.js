  ...
  return (
    <section className="container bg-white max-w-7xl mx-auto py-4 md:py-6">
      <div className="flex justify-center">
        ...
        >
          <div className="bg-black text-white px-3 py-1 rounded-full flex gap-1 items-center group-hover:text-pink-500 group-hover:bg-slate-800 transition-colors">
            <p className="">{tr.postOnX}</p>
            <svg
              viewBox="0 0 24 24"
              className="w-5 h-5 fill-white group-hover:fill-pink-500 transition-colors"
            >
