  ...
  return (
    <li className="w-full lg:w-fit">
      ...
      <Link
        ...
        onClick={toggle}
        aria-current={isActive ? "page" : undefined}
        className={`${isActive ? "lg:text-pink-500 block bg-gray-950 lg:bg-transparent text-right text-sm" : "text-white block text-right text-sm hover:bg-gray-950"} " lg:hover:bg-transparent lg:hover:text-pink-500 whitespace-nowrap px-8 lg:px-2 xl:px-3 py-4 transition-colors duration-300 ease"`}
      >
        {display}
      </Link>
    </li>
